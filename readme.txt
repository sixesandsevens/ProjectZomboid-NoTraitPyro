...
Compatibility
-------------
- Added compatibility for Build 42 timed action initialization.
...
Notes
-----
- This is intentionally designed to be expandable: new paper-like items can be added by updating `NoTraitPyro.isFlammable()`.
